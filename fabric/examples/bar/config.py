...
from fabric.hyprland.widgets import WorkspaceButton, Workspaces, get_hyprland_connection
    ...
    def __init__(self, **kwargs):
        ...
        self.event_box = EventBox(
            ...
            child=Overlay(
                ...
                overlays=Label(
                    label="",
                    style="margin: 0px 6px 0px 0px;",  # to center the icon glyph
                ),
            ),
        )
...
class StatusBar(Window):
    def __init__(
        ...
        self.active_window = ActiveWindow(
            name="hyprland-window", tooltip_text="Active window"
        )
